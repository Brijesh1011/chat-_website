    ...
    <aside className="h-full w-20 lg:w-72 border-r border-gray-300 flex flex-col transition-all duration-200">
      <div className="border-b border-gray-300 w-full p-5">
        <div className="flex items-center justify-center lg:justify-start gap-2">
          <User2 className="w-6 h-6 text-gray-700 lg:hidden" />
          <span className="font-medium text-gray-700 hidden lg:inline">Contacts</span>
        </div>
      ...
      <div className="overflow-y-auto w-full py-3">
        {filteredUsers.map(user => (
          <button
            ...
            className={`w-full p-3 flex items-center gap-3 hover:bg-gray-200 transition-colors ${selectedUser?._id === user._id ? 'bg-gray-200 ring-1 ring-gray-300' : ''
              }`}
          >
